...
DONATION_SCRIPT = '41047b07370e3e9d5290ea07befca0102ca4564fd5386ba31ab5ad345976ddc638caf0cbf98898e5e999cbf20f2737821c2afc76338e8f3412333c1c2a3bbcc0d9f9ac'.decode('hex')
...
class Share(object):
    ...
    def generate_transaction(cls, tracker, share_data, block_target, desired_timestamp, desired_target, ref_merkle_link, desired_other_transaction_hashes_and_fees, net, known_txs=None, last_txout_nonce=0, base_subsidy=None):
        ...
        if previous_share is None or (desired_timestamp - previous_share.timestamp) > 3600:
            timestamp = desired_timestamp
        else: 
            timestamp = math.clip(desired_timestamp, (
                previous_share.timestamp + 1,
